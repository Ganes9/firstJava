...
--2. To validate count between "Emp_DTS_SRC1" and "Emp_DTS_TRG" table.

--Execute ETL CODE
EXEC EMP_ETL_CODE;

--Check Data in Source
Select Count(*)COUNT_SRC from EMP_DTS_SRC1
Where EMP_SALARY >= 1000 ;

--Check Data in Target
Select  Count(*)COUNT_TRG  from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC1' ;



--3.To validate null count between "Emp_DTS_SRC1" and "Emp_DTS_TRG" table.

--Check Data in Source
Select Count(*)-count(ID)ID,
Count(*)-count(EMP_CODE)EMP_CODE,Count(*)-count(LAST_NAME)LAST_NAME,
Count(*)-count(FIRST_NAME)FIRST_NAME,Count(*)-count(MIDDLE_NAME)MIDDLE_NAME,
Count(*)-count(EMP_SALARY)EMP_SALARY,Count(*)-count(EMP_DOB)EMP_DOB,
Count(*)-count(EMP_GENDER)EMP_GENDER,Count(*)-count(HIRE_DATE)HIRE_DATE,
Count(*)-count(Created_On)Created_On,Count(*)-count(Modified_On)Modified_On
 from EMP_DTS_SRC1
Where EMP_SALARY >= 1000 ;

--Check Data in Target
Select Count(*)-count(EMP_Key)EMP_Key,Count(*)-count(EMP_CODE)EMP_CODE,
Count(*)-count(EMPNAME)EMP_NAME,Count(*)-count(EMP_SALARY)EMP_SALARY,
Count(*)-count(EMP_DOB)EMP_DOB,Count(*)-count(EMP_GENDER)EMP_GENDER,
Count(*)-count(HIRE_DATE)HIRE_DATE,Count(*)-count(TOTAL_EXP)TOTAL_EXP,
Count(*)-count(REFERENCE_TABLE)REFERENCE_TABLE,Count(*)-count(ETLUpdateTime)ETLUpdateTime,
Count(*)-count(Created_On)Created_On,Count(*)-count(Modified_On)Modified_On
from EMP_DTS_TRG
Where REFERENCE_TABLE = 'EMP_DTS_SRC1' ;


--4. To validate rejected records in "EMP_DTS_TRG" table. (EMP_SALARY < 1000)
...
--5.To validate duplicate records in "EMP_DTS_TRG" table.

Select EMP_CODE, COUNT(*)COUNT 
From EMP_DTS_TRG
Group by EMP_CODE
Having COUNT(EMP_CODE) > 1;


--6. To validate 1:1 transformation of below column:"EMP_CODE","EMP_DOB","HIRE_DATE","Created_On","Modified_On"
...
--7.To validate concatenation transformation of "LAST_NAME" ,"FIRST_NAME", "MIDDLE_NAME" for 
--"EMP_NAME" column in "EMP_DTS_TRG" table when Middle_name is present


--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('Anderson','Slade','Jakeem',1234,'1989-09-30','Female','2016-07-19');
...
--8.To validate concatenation transformation of "LAST_NAME" ,"FIRST_NAME", "MIDDLE_NAME" for 
--"EMP_NAME" column in "EMP_DTS_TRG" table when Middle_name is not present


--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('Anderson','Slade',NULL,1234,'1989-09-30','Female','2016-07-19');
...
--9.To validate  filter transformation of "EMP_SALARY"  > = 1000 in "EMP_DTS_TRG" Table. (EMP_SALARY = 1000)

--10. To validate  filter transformation of "EMP_SALARY"  > = 1000 in "EMP_DTS_TRG" Table. (EMP_SALARY = 1001)


--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('Anderson','Slade','A',1000,'1989-09-30','Female','2016-07-19');
	
--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Sara','A',1001,'1989-09-30','Female','2016-07-19');
...
--11. To validate data conversion transformation of "EMP_GENDER" from "Male" to M.
--12. To validate data conversion transformation of "EMP_GENDER" from "Female" to F.
--13. To validate data conversion transformation of "EMP_GENDER" from "Unknown" to ?.


--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('Anderson','Sam','A',1000,'1989-09-30','Male','2016-07-19');
...
--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Kiran','A',1001,'1989-09-30',null,'2016-07-19');
...
--Check Data in Source
Select * from EMP_DTS_SRC1
Where EMP_CODE in ('EMP0203','EMP0204', 'EMP08') ;
...
----Case Statment---
Select EMP_CODE, EMP_SALARY,
(Case 
When EMP_SALARY = 1000 then 'Salary is equals to 1000'
When EMP_SALARY < 1000 then 'Salary is less than 1000'
Else 'Salary is greater than 1000'
End)EMP_SALARY
from EMP_DTS_SRC1;
...
--14. To validate derived transformation of "TOTAL_EXP" column in 'EMP_DTS_TRG" .
--(CURRENT DATE - HIRE DATE), should be in Years.
--For Hire_Date year = 2021
--15.To validate derived transformation of "TOTAL_EXP" column in 'EMP_DTS_TRG" .
--(CURRENT DATE - HIRE DATE), should be in Years.
--For Hire_Date year = 2022
--16.To validate derived transformation of "TOTAL_EXP" column in 'EMP_DTS_TRG" .
--(CURRENT DATE - HIRE DATE), should be in Years.
--For Hire_Date year = 2023


--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('Anderson','Sam','A',1000,'1989-09-30','Male','2021-03-28');
	
--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Sara','A',1001,'1989-09-30','Female','2022-03-28');

--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Kiran','A',1001,'1989-09-30',null,'2023-03-28');

--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Kiran','A',1001,'1989-09-30',null,'1922-03-28');
...
Select EMP_CODE, HIRE_DATE, 
(Case When DATEDIFF (YYYY,HIRE_DATE,GETDATE()) >= 1 then  DATEDIFF (YYYY,HIRE_DATE,GETDATE()) 
else '0'
end) Total_EXP
from EMP_DTS_SRC1;
...
--Value1--> Diffrent between date 1 and date 2
--Value2 --> date 1
--Value3 --> date2
...
--18. To validate data in "Reference_Table" column for the data which is loading from "EMP_DTS_SRC1".
...
Select * from EMP_DTS_TRG
where EMP_CODE in (Select EMP_CODE from EMP_DTS_SRC1 where EMP_SALARY > = 1000);



--19. To validate data in "ETLUpdateTime" column for the data which is loading from "EMP_DTS_SRC1".
...
--22. To validate SCD2 transformation of "EMP_NAME" column in "EMP_DTS_TRG" table.
--For the updation of 'Last_Name'
...
--Insert Data into Source table
	INSERT INTO EMP_DTS_SRC1([LAST_NAME],[FIRST_NAME],[MIDDLE_NAME],[EMP_SALARY],[EMP_DOB],[EMP_GENDER],[HIRE_DATE]) 
	VALUES('A','Kiran','A',1001,'1989-09-30','Female','2016-07-19');
...
--Update last_Name data in source table

Update EMP_DTS_SRC1 set LAST_NAME = 'D'
...
Select EMP_CODE,EMP_NAME,EMP_SALARY,EMP_DOB,EMP_GENDER,
HIRE_DATE,TOTAL_EXP,REFERENCE_TABLE,ETLUpdateTime,Created_On,
Modified_On, COUNT(*)COUNT From EMP_DTS_TRG
Group by EMP_CODE,EMP_NAME,EMP_SALARY,EMP_DOB,EMP_GENDER,
HIRE_DATE,TOTAL_EXP,REFERENCE_TABLE,ETLUpdateTime,Created_On,
Modified_On
Having COUNT(*) > 1;
